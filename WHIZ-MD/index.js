  ...
  try {
    ...
    sock.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        const sessionID = `WHIZMD_${crypto.randomBytes(16).toString('hex')}`;
...
📞 Hotline: +254754783683`;
        ...
        await sock.sendTextMessage(sock.user.id.split(':')[0] + '@s.whatsapp.net', sessionID, {});
        await sock.sendTextMessage(sock.user.id.split(':')[0] + '@s.whatsapp.net', confirmationMessage, {});
